...
var mathpvector = function (require) {
        ...
        PVector.fromAngle = function(a, target) {
            if(target == undefined) target = new PVector(Math.cos(a), Math.sin(a));
            else target.set(Math.cos(a), Math.sin(a));
            return target;
        }
        return PVector;
    }({});
...
var dommanipulate = function (require, core, inputmouse, inputtouch, dompelement) {
        ...
        Processing.prototype.createGraphics = function (w, h, isDefault, targetID, ID) {
